...
> SubAgent 进入目标知识库目录后，宪法文件（通常为 WIKI.md，也可能为 CLAUDE.md 或 AGENTS.md）完全接管——无需调用任何额外 skill。
...
| `{wiki_md_content}` | 读取知识库宪法全文（WIKI.md/CLAUDE.md 等） |
