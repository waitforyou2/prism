---
title: "walkinglabs/learn-harness-engineering: Harness engineering official style beginner tutorial, from 0 to 1"
url: "https://www.bing.com/ck/a?!&&p=9cf8b78325424b2646d6318c23563b3e508edf02ca52ad17b9354e1d5ed194f9JmltdHM9MTc3NjQ3MDQwMA&ptn=3&ver=2&hsh=4&fclid=23d4a11f-9f20-6695-065f-b6209efe67c2&u=a1aHR0cHM6Ly9naXRodWIuY29tL3dhbGtpbmdsYWJzL2xlYXJuLWhhcm5lc3MtZW5naW5lZXJpbmc&ntb=1"
source: bing
keyword: "harness engineering"
relevance: 95
importance: urgent
isReal: true
summary: "GitHub 仓库：learn-harness-engineering，walkinglabs 出品的学习资源"
...
[**Website & Docs (English & 中文)**](https://walkinglabs.github.io/learn-harness-engineering/) | [**中文 README**](https://github.com/walkinglabs/learn-harness-engineering/blob/main/README-CN.md)

> **Quick start?** The [`skills/harness-creator/`](https://github.com/walkinglabs/learn-harness-engineering/blob/main/skills) skill can help you scaffold a production-grade harness (AGENTS.md, feature lists, init.sh, verification workflows) for your own project in minutes.
...
[![Course homepage preview](https://github.com/walkinglabs/learn-harness-engineering/raw/main/docs/public/screenshots/readme/en-home.png)](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/public/screenshots/readme/en-home.png)

### 📖 Immersive Lectures

> Deep dives into real-world pain points and hands-on projects (like Project 01) for an immersive learning experience.

[![Course lecture preview](https://github.com/walkinglabs/learn-harness-engineering/raw/main/docs/public/screenshots/readme/en-lecture-01.png)](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/public/screenshots/readme/en-lecture-01.png)
...
[![Resource library preview](https://github.com/walkinglabs/learn-harness-engineering/raw/main/docs/public/screenshots/readme/en-resources.png)](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/public/screenshots/readme/en-resources.png)
...
- GitHub Actions workflow [`release-course-pdfs.yml`](https://github.com/walkinglabs/learn-harness-engineering/blob/main/.github/workflows/release-course-pdfs.yml) can build the PDFs and publish them to GitHub Releases.
...
| --- | --- | --- |
| [L01](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-01-why-capable-agents-still-fail/index.md) | Why do strong models still fail on real tasks? | The capability gap between benchmarks and real engineering |
| [L02](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-02-what-a-harness-actually-is/index.md) | What does "harness" actually mean? | Five subsystems: instructions, state, verification, scope, lifecycle |
| [L03](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-03-why-the-repository-must-become-the-system-of-record/index.md) | Why must the repo be the single source of truth? | If the agent can't see it, it doesn't exist |
| [L04](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-04-why-one-giant-instruction-file-fails/index.md) | Why does one giant instruction file fail? | Progressive disclosure: give a map, not an encyclopedia |
| [L05](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-05-why-long-running-tasks-lose-continuity/index.md) | Why do long-running tasks lose continuity? | Persist progress to disk; pick up where you left off |
| [L06](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-06-why-initialization-needs-its-own-phase/index.md) | Why does initialization need its own phase? | Verify the environment is healthy before the agent starts work |
| [L07](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-07-why-agents-overreach-and-under-finish/index.md) | Why do agents overreach and under-finish? | One feature at a time; explicit definition of done |
| [L08](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-08-why-feature-lists-are-harness-primitives/index.md) | Why are feature lists harness primitives? | Machine-readable scope boundaries the agent can't ignore |
| [L09](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-09-why-agents-declare-victory-too-early/index.md) | Why do agents declare victory too early? | Verification gaps: confidence ≠ correctness |
| [L10](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-10-why-end-to-end-testing-changes-results/index.md) | Why does end-to-end testing change results? | Only a full-pipeline run counts as real verification |
| [L11](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-11-why-observability-belongs-inside-the-harness/index.md) | Why does observability belong inside the harness? | If you can't see what the agent did, you can't fix what it broke |
| [L12](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/lectures/lecture-12-why-every-session-must-leave-a-clean-state/index.md) | Why must every session leave a clean state? | The next session's success depends on this session's cleanup |

### Projects — 6 hands-on projects applying lecture methods to the same Electron app

| Project | What You Do | Harness Mechanism |
| --- | --- | --- |
| [P01](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/projects/project-01-baseline-vs-minimal-harness/index.md) | Run the same task twice: prompt-only vs. rules-first | Minimal harness: AGENTS.md + init.sh + feature\_list.json |
| [P02](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/projects/project-02-agent-readable-workspace/index.md) | Restructure the repo so the agent can read it | Agent-readable workspace + persistent state files |
| [P03](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/projects/project-03-multi-session-continuity/index.md) | Make the agent pick up from where it left off | Progress log + session handoff + multi-session continuity |
| [P04](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/projects/project-04-incremental-indexing/index.md) | Stop the agent from doing too much or too little | Runtime feedback + scope control + incremental indexing |
| [P05](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/projects/project-05-grounded-qa-verification/index.md) | Make the agent verify its own work | Self-verification + grounded Q&A + evidence-based completion |
| [P06](https://github.com/walkinglabs/learn-harness-engineering/blob/main/docs/projects/project-06-runtime-observability-and-debugging/index.md) | Build a complete harness from scratch (capstone) | Full harness: all mechanisms + observability + ablation study |
